...
public class CreateMovieViewingHistoryResponse {
  @ApiModelProperty("The movie viewing date created.")
  @JsonFormat(pattern = "MM/dd/yyyy")
  private final LocalDate viewingDate;

  @ApiModelProperty("The identifier of the movie viewing history created.")
  private final long id;

  @ApiModelProperty("The movie identifier of the movie viewing date created.")
