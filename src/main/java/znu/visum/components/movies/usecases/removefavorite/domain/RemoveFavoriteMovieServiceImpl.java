...
@Service
public class RemoveFavoriteMovieServiceImpl implements RemoveFavoriteMovieService {
  private final MovieRepository movieRepository;

  @Autowired
  public RemoveFavoriteMovieServiceImpl(MovieRepository movieRepository) {
