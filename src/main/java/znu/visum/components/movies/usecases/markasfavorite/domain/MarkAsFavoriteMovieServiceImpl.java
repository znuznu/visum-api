...
@Service
public class MarkAsFavoriteMovieServiceImpl implements MarkAsFavoriteMovieService {
  private final MovieRepository movieRepository;

  @Autowired
  public MarkAsFavoriteMovieServiceImpl(MovieRepository movieRepository) {
