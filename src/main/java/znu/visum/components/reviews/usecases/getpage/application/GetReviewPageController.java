...
import znu.visum.components.reviews.usecases.getpage.domain.GetReviewPage;
...
public class GetReviewPageController {

  private final GetReviewPage getReviewPage;

  @Autowired
  public GetReviewPageController(GetReviewPage getReviewPage) {
    this.getReviewPage = getReviewPage;
  }
  ...
  public GetPageResponse<ReviewFromPageResponse> getPage(
    ...
    return GetPageResponse.from(
        getReviewPage.process(limit, offset, sort, search), ReviewFromPageResponse::from);
  }
}
