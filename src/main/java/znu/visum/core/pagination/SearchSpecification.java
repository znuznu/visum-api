...
public class SearchSpecification<T> implements Specification<T> {
    ...
    /**
     * Create a Specification based on an expression.
     * Currently, only OR and AND are supported.
     * This method is way too simple and isn't scalable.
     *
    ...
    public Predicate toPredicate(Root<T> root, CriteriaQuery<?> criteriaQuery, CriteriaBuilder cb) {
        ...
        switch (operator) {
            ...
            default:
                throw new UnsupportedOperationException(String.format("Unsupported operator found '%s'", operator));
        }
    }
