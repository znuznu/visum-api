...
class DeleteByIdMovieViewingHistoryIntegrationTest {
  @Container
  private static final PostgreSQLContainer container = new PostgreSQLContainer("postgres:12.4");

  @Autowired private DeleteByIdMovieViewingHistory service;
  ...
  void
    ...
    Assertions.assertThrows(NoSuchViewingHistoryException.class, () -> service.process(1000L));
  }
