...
class MarkMovieAsFavoriteRouteIntegrationTest {

  public static final String URL_TEMPLATE = "/api/movies/{id}/favorite";
  ...
  void givenANumericalId_whenAMovieWithTheIdExists_itShouldReturnA204Response() throws Exception {
    mvc.perform(put(URL_TEMPLATE, '4').contentType(MediaType.APPLICATION_JSON_VALUE))
