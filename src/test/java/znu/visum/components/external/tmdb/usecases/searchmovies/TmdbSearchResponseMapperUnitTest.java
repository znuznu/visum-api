package znu.visum.components.external.tmdb.usecases.searchmovies;

import org.junit.jupiter.api.DisplayName;
import org.junit.jupiter.api.Nested;
import org.junit.jupiter.api.Test;
import znu.visum.components.external.domain.models.ExternalMovieFromSearch;
import znu.visum.components.external.tmdb.infrastructure.models.TmdbMovieFromSearch;
import znu.visum.components.external.tmdb.infrastructure.models.TmdbSearchResponse;
import znu.visum.components.external.tmdb.infrastructure.models.TmdbSearchResponseMapper;
...
public class TmdbSearchResponseMapperUnitTest {
  ...
  class SearchMovie {
    ...
    public void itShouldMapWithIsFirstToTrueAndIsLastToFalse() {
      ...
      movies[0] = new TmdbMovieFromSearch(1, "Movie 1", LocalDate.of(1990, 12, 18));
      movies[1] = new TmdbMovieFromSearch(2, "Movie 2", LocalDate.of(1991, 12, 18));
      movies[2] = new TmdbMovieFromSearch(3, "Movie 3", LocalDate.of(1992, 12, 18));
